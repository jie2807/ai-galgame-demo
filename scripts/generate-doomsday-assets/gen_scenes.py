#!/usr/bin/env python3
"""
为官方剧本「末世方舟」批量生成 18 个场景背景图。
调用 byted-seedream-image-generate skill，结果直接保存到 images/scenes/doomsday/<locationid>.png。
...
# 最终输出目录
OUT_DIR = PROJECT_ROOT / "images" / "scenes" / "doomsday"
